...
loadNullableAsObject : InferredTypeStore -> String -> LVar -> Asm ()
loadNullableAsObject sourceLocTys targetTy var =
    let loadInstr = \index => do
                                Aload index
                                InvokeMethod InvokeStatic  (rtClass "Nullables") "nullableToObject"
